  ...
  */
    ...
    */
    ...
    GPIO_InitStruct.Pin = GPIO_PIN_15|GPIO_PIN_14|GPIO_PIN_12|GPIO_PIN_13
                          |GPIO_PIN_11|GPIO_PIN_10|GPIO_PIN_0|GPIO_PIN_8
...
void HAL_TIM_Base_MspInit(TIM_HandleTypeDef* htim_base)
{
  ...
  /* USER CODE END TIM2_MspInit 0 */
    ...
    PA0     ------> TIM2_ETR
    */
    GPIO_InitStruct.Pin = DES_RCLK_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF1_TIM2;
    HAL_GPIO_Init(DES_RCLK_GPIO_Port, &GPIO_InitStruct);
...
void HAL_TIM_Base_MspDeInit(TIM_HandleTypeDef* htim_base)
{
  ...
  /* USER CODE END TIM2_MspDeInit 0 */
    ...
    PA0     ------> TIM2_ETR
    */
    HAL_GPIO_DeInit(DES_RCLK_GPIO_Port, DES_RCLK_Pin);
...
static void HAL_FMC_MspDeInit(void){
  ...
  PD8   ------> FMC_D13
  */
  HAL_GPIO_DeInit(GPIOE, GPIO_PIN_0|GPIO_PIN_10|GPIO_PIN_9|GPIO_PIN_11
                          |GPIO_PIN_12|GPIO_PIN_15|GPIO_PIN_8|GPIO_PIN_13
                          |GPIO_PIN_7|GPIO_PIN_14);
